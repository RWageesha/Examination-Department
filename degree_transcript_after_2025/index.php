...
<head>
    ...
    /* Align certificate list into two columns (label and fixed qty column) */
    .list-group {
        width: 100%;
    }
    .list-group-item {
    ...
    .list-group-item > .cert-qty-holder {
        display: table-cell;
        width: 110px;
        vertical-align: middle;
        text-align: right;
    ...
    .cert-qty { width: 90px; max-width: 90px; }
    .cert-label-no-wrap { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    /* Keep the long 'If lost/damaged...' label on a single line */
    #is_second_copy_of_detailed_degree_certificate_already_issued + label,
    input#is_second_copy_of_detailed_degree_certificate_already_issued + label.form-check-label {
        white-space: nowrap;
        overflow: hidden;
    ...
    <div class="terms-modal" id="termsModal">
        ...
        <div class="terms-modal-body">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td><strong>1. Transcript </strong></td>
                        <td>300/-</td>
                        <td>2000/-</td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td><strong>2. Second Copy of Transcript </strong></td>
                        <td>1500/-</td>
                        <td>3000/-</td>
                    ...
                    <tr>
                        <td><strong>3. Transcript with Marks</strong></td>
                        <td>400/- & Postage</td>
                        <td>2000/- & Postage</td>
